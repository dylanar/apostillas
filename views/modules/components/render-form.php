                        ...
                        <div id="camposDinamicos">
                            <?php if (!empty($camposFormulario)): ?>
                                ...
                                <?php foreach ($grupos as $grupo): ?>
                                    ...
                                    <?php else: ?>
                                        <?php
                                        // Contar campos que NO son archivo para determinar el grid
                                        $camposNoArchivo = array_filter($grupo['items'], fn($c) => ($c['tipo'] ?? 'texto') !== 'archivo');
                                        $totalNoArchivo  = count($camposNoArchivo);
                                        // 1 campo → col-12 | 2 campos → col-6 | 3+ → col-lg-4
                                        if ($totalNoArchivo === 1) {
                                            $colBase = 'col-12';
                                        } elseif ($totalNoArchivo === 2) {
                                        ...
                                        <div class="row">
                                            <?php foreach ($grupo['items'] as $index => $campo): ?>
                                                ...
                                                // Archivo siempre full width, resto usa colBase calculado
