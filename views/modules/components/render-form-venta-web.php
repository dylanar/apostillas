                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" id="celular" name="celular"
                                        ...
                                        value="<?= $cliente["telefono"]; ?>" autocomplete="tel">
                                </div>
                                <div class="form-text">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" id="whatsapp" name="whatsapp"
                                        placeholder="3001234567" pattern="[0-9]{10}" maxlength="10"
                                        value="<?= $cliente["wpp"]; ?>" autocomplete="tel">
                                </div>
                                <div class="form-text">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form id="formPaso2" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="formRegistroVentaNC" value="formRegistroVentaNC">
                        <input type="hidden" name="id_cliente" value="<?= $id_cliente; ?>">
                        <input type="hidden" name="codigo_seguimiento" value="<?= $codigo_seguimiento; ?>">
    ...
    <?php endif; ?>
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="terminos">
                                Acepto los <a href="<?= BASE_URL; ?>terminos" target="_blank">términos y condiciones</a>
                                y la <a href="<?= BASE_URL; ?>privacidad" target="_blank">política de privacidad</a>
